...
namespace Domain::Account
{
  class AccountHandler
  {
    public:
      ...
      virtual AccountCredentials getAccountInfo(std::string accountID) = 0;
      virtual std::string getUserReport(std::string accountID) = 0;
      virtual std::string setUsername(std::string username) = 0;
      virtual std::string setPassword(std::string password) = 0;
