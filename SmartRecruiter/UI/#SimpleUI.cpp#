  ...
  void SimpleUI::launch()
  {
    ...
    do
    {
      ...
      ******************************************************************************************************************************/
      ...
      {
	std::cout << "Enter your credit card type: ";
	std::cin >> creditCardType;
        if (TechnicalServices::Payment::PaymentHandler::CheckCreditCardType(creditCardType) == false) 
	{                                          
	    std::cout << "Invalid credit card type";                                                
        }                                                                                           
        else                                                                                         
        {                                                                                            
	   ...
	   sessionControl = Domain::Session::SessionHandler::createSession( credentials );
           if (TechnicalServices::Payment::PaymentHandler::CheckCreditCardNumber(creditCardNumber) == false) 
	   {                            
